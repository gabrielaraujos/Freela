...
public class FreelaDBHandler extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_OPORTUNIDADE_ID = " _id";
    private static final String COLUMN_OPT_ID = " _id";
    ...
    private static final String CREATE_OPORTUNIDADE_TABLE = "CREATE TABLE " + TABLE_OPORTUNIDADE + " (" +
            COLUMN_OPT_ID + " INTEGER PRIMARY KEY AUTO INCREMENT, " +
            COLUMN_TITULO + " TEXT, " +
    ...
    public Usuario findUsuario(String email, String senha) {
        ...
        Cursor cursor = db.query(true, TABLE_USUARIO, columns, COLUMN_EMAIL + "='" + email + "' AND " + COLUMN_SENHA + "='" + senha  + "'", null, null, null, null, null);
        ...
        if (cursor.moveToFirst()) {
            ...
            //usuario.setPapel(Integer.parseInt(cursor.getString(4)));
            cursor.close();
        } else {
            usuario = null;
        }
    ...
    public Freelancer findFreelancer(int id) {
        ...
        Cursor cursor = db.query(true, TABLE_FREELANCER, columns, COLUMN_ID + "='" + id + "'", null, null, null, null, null);
