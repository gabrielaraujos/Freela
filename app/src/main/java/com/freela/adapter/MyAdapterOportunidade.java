...
public class MyAdapterOportunidade extends RecyclerView.Adapter<MyAdapterOportunidade.MyViewHolder> {
    private ArrayList<Oportunidade> listOportunidades;
    private Context mContext;

    private OportunidadeOnClickListener oportunidadeOnClickListener;

    public MyAdapterOportunidade(Context context, ArrayList<Oportunidade> oportunidades, OportunidadeOnClickListener oportunidadeOnClickListener) {
    ...
    @Override
    public MyAdapterOportunidade.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_oportunidades, parent, false);
        MyAdapterOportunidade.MyViewHolder holder = new MyViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(final MyAdapterOportunidade.MyViewHolder holder, final int position) {
